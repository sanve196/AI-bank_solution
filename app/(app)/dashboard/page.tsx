...
const modules = [
  ...
  { code: "06", title: "Process Analytics & TAT", desc: "Conversational analytics for managers on process velocity.", icon: Timer, href: "/uc-06-process-analytics", status: "live" },
